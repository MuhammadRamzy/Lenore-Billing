    ...
    <>
      ...
      <div className={cn(
        ...
        <div>
          <div className="flex items-center justify-between px-5 py-4 border-b border-slate-800">
            ...
            <button 
              onClick={() => setIsOpen(false)}
              className="p-1.5 rounded-lg text-slate-500 hover:text-white animate-pulse"
            >
              <X className="h-5 w-5" />
            </button>
          </div>
        ...
        <div className="p-4 border-t border-slate-800 bg-slate-950/40 m-4 rounded-xl">
          ...
          <div className="text-[0.72rem] text-slate-500 mt-0.5">GST: {company.gstin}</div>
        </div>
      </div>
      ...
      <nav className="fixed bottom-0 left-0 right-0 z-50 bg-slate-900 border-t border-slate-800 text-white lg:hidden flex justify-around items-center h-16 px-2 print:hidden safe-bottom">
        ...
        <Link
          href="/dashboard"
          className={cn(
            "flex flex-col items-center justify-center flex-1 h-full py-1 relative text-slate-500 active:scale-95 transition-transform duration-100",
            pathname === "/dashboard" ? "text-indigo-400 font-extrabold" : "hover:text-slate-200"
          )}
        >
          <LayoutDashboard className="h-5 w-5 mb-0.5 shrink-0" />
          <span className="text-[0.68rem] uppercase tracking-wider leading-none">Dashboard</span>
          {pathname === "/dashboard" && (
        ...
        >
          ...
          <span className="text-[0.68rem] uppercase tracking-wider leading-none">Invoices</span>
        ...
        >
          ...
          <span className="text-[0.68rem] uppercase tracking-wider leading-none">Products</span>
        ...
        >
          ...
          <span className="text-[0.68rem] uppercase tracking-wider leading-none">Menu</span>
          {isOpen && (
            <span className="absolute bottom-1.5 h-1 w-1 rounded-full bg-indigo-400 animate-pulse" />
          )}
        </button>
      ...
      <aside className="hidden lg:flex fixed inset-y-0 left-0 z-30 w-64 bg-slate-900 border-r border-slate-800 text-white flex-col justify-between print:hidden">
        ...
        <div className="p-5 border-t border-slate-800 bg-slate-950/40 m-4 rounded-xl space-y-3">
          <div>
            <div className="text-[0.72rem] text-slate-500 font-bold uppercase tracking-wider mb-1.5">
              Active Terminal
            </div>
            <div className="text-sm font-bold text-slate-200">{company.name}</div>
            <div className="text-xs text-slate-500 mt-1">GST: {company.gstin}</div>
          ...
          <button
            ...
            className="w-full flex items-center justify-center gap-1.5 py-2 bg-slate-850 hover:bg-slate-800 text-xs text-slate-400 font-bold rounded-lg transition-colors border border-slate-800 hover:border-slate-700"
          >
          ...
          <div className="bg-white rounded-2xl max-w-sm w-full p-6 shadow-2xl border border-slate-100 flex flex-col gap-4 text-slate-800 animate-in fade-in zoom-in-95 duration-200">
            <div className="flex justify-between items-center border-b pb-3">
              ...
              <button
                ...
                className="text-slate-500 hover:text-slate-600 font-extrabold text-sm"
              >
                ✕
              </button>
            </div>
            ...
            <div className="space-y-3 py-1 text-xs">
              <div className="text-slate-500 font-bold uppercase tracking-wider text-[0.72rem]">Navigation</div>
              <div className="flex justify-between items-center">
                <span>Go to Dashboard</span>
                <kbd className="px-2 py-0.5 bg-slate-100 border border-slate-200 rounded font-mono text-[0.68rem] text-slate-600 shadow-sm">Alt + Shift + 1</kbd>
              </div>
              <div className="flex justify-between items-center">
                <span>Go to Invoices</span>
                <kbd className="px-2 py-0.5 bg-slate-100 border border-slate-200 rounded font-mono text-[0.68rem] text-slate-600 shadow-sm">Alt + Shift + 2</kbd>
              </div>
              <div className="flex justify-between items-center">
                <span>Go to Purchases</span>
                <kbd className="px-2 py-0.5 bg-slate-100 border border-slate-200 rounded font-mono text-[0.68rem] text-slate-600 shadow-sm">Alt + Shift + 3</kbd>
              </div>
              <div className="flex justify-between items-center">
                <span>Go to Customers</span>
                <kbd className="px-2 py-0.5 bg-slate-100 border border-slate-200 rounded font-mono text-[0.68rem] text-slate-600 shadow-sm">Alt + Shift + 4</kbd>
              </div>
              <div className="flex justify-between items-center">
                <span>Go to Products</span>
                <kbd className="px-2 py-0.5 bg-slate-100 border border-slate-200 rounded font-mono text-[0.68rem] text-slate-600 shadow-sm">Alt + Shift + 5</kbd>
              </div>
              <div className="flex justify-between items-center">
                <span>Go to Settings</span>
                <kbd className="px-2 py-0.5 bg-slate-100 border border-slate-200 rounded font-mono text-[0.68rem] text-slate-600 shadow-sm">Alt + Shift + 6</kbd>
              </div>
              <div className="flex justify-between items-center">
                <span>Go to Expenses</span>
                <kbd className="px-2 py-0.5 bg-slate-100 border border-slate-200 rounded font-mono text-[0.68rem] text-slate-600 shadow-sm">Alt + Shift + 7</kbd>
              </div>
              <div className="flex justify-between items-center font-semibold text-slate-900 border-t pt-2 mt-2">
                <span>Create New Invoice</span>
                <kbd className="px-2 py-0.5 bg-indigo-50 border border-indigo-100 rounded font-mono text-[0.68rem] text-indigo-600 shadow-sm">Alt + Shift + N</kbd>
              </div>
              <div className="flex justify-between items-center font-semibold text-slate-900">
                <span>Create New Purchase</span>
                <kbd className="px-2 py-0.5 bg-indigo-50 border border-indigo-100 rounded font-mono text-[0.68rem] text-indigo-600 shadow-sm">Alt + Shift + P</kbd>
              </div>

              <div className="text-slate-500 font-bold uppercase tracking-wider text-[0.72rem] pt-2">Invoice Creator</div>
              <div className="flex justify-between items-center">
                <span>Add Line Item</span>
                <kbd className="px-2 py-0.5 bg-slate-100 border border-slate-200 rounded font-mono text-[0.68rem] text-slate-600 shadow-sm">Alt + Shift + A</kbd>
              </div>
              <div className="flex justify-between items-center">
                <span>Save & Submit Invoice</span>
                <kbd className="px-2 py-0.5 bg-slate-100 border border-slate-200 rounded font-mono text-[0.68rem] text-slate-600 shadow-sm">Alt + Shift + S</kbd>
              </div>

              <div className="text-slate-500 font-bold uppercase tracking-wider text-[0.72rem] pt-2">Invoice Detail View</div>
              <div className="flex justify-between items-center">
                <span>Trigger Page Print</span>
                <kbd className="px-2 py-0.5 bg-slate-100 border border-slate-200 rounded font-mono text-[0.68rem] text-slate-600 shadow-sm">Alt + Shift + P</kbd>
              </div>
              <div className="flex justify-between items-center">
                <span>Download PDF Invoice</span>
                <kbd className="px-2 py-0.5 bg-slate-100 border border-slate-200 rounded font-mono text-[0.68rem] text-slate-600 shadow-sm">Alt + Shift + D</kbd>
              </div>
            </div>
